          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 space-y-8">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600 text-sm">
                ...
                <a href="mailto:support@maketrend.com" className="text-purple-600 hover:underline">support@maketrend.com</a>.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="mt-2 text-gray-600 text-sm">
                <p>Email: <a href="mailto:support@maketrend.com" className="text-purple-600 hover:underline">support@maketrend.com</a></p>
                <p>Address: Make Trend, [Your City, Country]</p>
              </div>
            </div>
