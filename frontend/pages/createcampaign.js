  ...
  if (campaignUrl) {
    ...
    return (
      <>
        ...
        <main className="min-h-screen flex items-center justify-center px-4 py-4 bg-gradient-to-b from-gray-50 to-white">
          <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            {/* Header - reduced padding */}
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-5 py-3 sm:px-6 sm:py-4">
