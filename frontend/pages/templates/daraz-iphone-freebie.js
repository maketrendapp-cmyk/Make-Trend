// pages/templates/daraz-iphone-freebie.js
...
const defaultMeta = {
  ...
  url: 'https://maketrend.app/daraz-iphone-freebie', // ✅ Clean base URL
};
  ...
  return (
    <div className="page-wrapper">
          ...
          {WINNERS.map((winner, idx) => (
            <div key={idx} className="win-item">
              ...
              <div className="win-info">
                ...
                <span className="win-product">
                  won FREE <strong className="text-white">{winner.product}</strong>
                </span>
              </div>
            </div>
          ))}
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; }
        body { background: var(--bg-base); color: var(--text-main); line-height: 1.6; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale; }
        ...
        .hero {
          ...
          overflow: hidden;
          background: radial-gradient(ellipse at 30% 20%, rgba(10, 132, 255, 0.06) 0%, transparent 60%);
        }
        .hero-glow {
          position: absolute;
          border-radius: 50%;
        ...
        .highlight-row { padding-top: 0.6rem; }
        .price-label {
          font-size: 0.85rem;
          font-weight: 500;
          color: var(--text-muted);
        ...
        .share-btn.twitter { background: #000; color: #fff; border: 1px solid rgba(255, 255, 255, 0.12); }
        ...
        .continue-btn.loading { opacity: 0.7; cursor: wait; }
        .spinner {
          width: 20px;
          height: 20px;
        ...
        .faq-item:hover .faq-icon { color: var(--brand-primary); }
        .faq-question {
          font-weight: 600;
          font-size: 0.95rem;
          color: #fff;
        ...
        @media (max-width: 768px) {
          ...
          .main-card { padding: 1.8rem 1.5rem; }
        ...
        @media (max-width: 480px) {
          ...
          .timer-section { padding: 0.6rem 1rem; flex-wrap: wrap; }
          .timer-text { font-size: 0.75rem; }
          .timer-value { font-size: 1rem; }
          .continue-btn { font-size: 1rem; padding: 1rem; }
          .faq-item { padding: 1rem 1.2rem; flex-direction: column; gap: 0.6rem; }
        }
      `}} />
    </div>
  );
