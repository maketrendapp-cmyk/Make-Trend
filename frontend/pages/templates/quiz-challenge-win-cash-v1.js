...
const defaultMeta = {
  ...
  url: 'https://maketrend.app/quiz-challenge-win-cash-v1', // ✅ Clean base URL
};
  ...
  return (
    <div className="page-wrapper">
      ...
      <header className="site-header">
        ...
        <div className="header-badge"><FaMoneyBillWave className="icon-inline" /> Win Real Cash</div>
      </header>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          {step === 1 && (
            <>
              <div className="hero-badge"><FaFire className="icon-inline" /> Limited Time</div>
              ...
              <div className="hero-stats">
                <div><FaMoneyBillWave className="icon-inline" /> $5,000 Prize Pool</div>
                <div><FaMedal className="icon-inline" /> 100+ Winners</div>
                <div><FaClock className="icon-inline" /> <span>{String(timeRemaining.hours).padStart(2, '0')}:{String(timeRemaining.minutes).padStart(2, '0')}:{String(timeRemaining.seconds).padStart(2, '0')}</span> Left</div>
              </div>
            </>
          )}
          {step === 2 && (
            <>
              <div className="hero-badge"><FaEdit className="icon-inline" /> Question {currentQuestion + 1} of {QUESTIONS.length}</div>
          ...
          {step === 3 && (
            <>
              ...
              <div className="hero-stats">
                <div><FaTrophy className="icon-inline" /> $100 Cash Prize</div>
                <div><FaCheckCircle className="icon-inline" /> Verified Entry</div>
                <div><FaClock className="icon-inline" /> Claim within 24h</div>
              </div>
            </>
          )}
        </div>
      ...
      <main className="main-content">
        ...
        {step === 1 && (
          <div className="register-card">
            ...
            <button className="join-btn" onClick={handleStartQuiz}>
              Start Quiz <FaArrowRight className="icon-inline" />
            </button>
        ...
        {step === 2 && (
          <div className="quiz-card">
            <div className="question-number"><FaQuestionCircle className="icon-inline" /> Question {currentQuestion + 1} of {QUESTIONS.length}</div>
              ...
              {QUESTIONS[currentQuestion].options.map((option, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {option}
                    {isSelected && <FaCheckCircle className="check-mark" />}
                  </button>
                );
              })}
            </div>
        ...
        {step === 3 && (
          <div className="result-card">
            <div className="result-icon"><FaTrophy style={{ color: '#f5a623' }} /></div>
            <h2>Congratulations, {fullName}!</h2>
            <p>You have successfully completed the quiz. You are now eligible to claim your reward.</p>
            <div className="prize-badge">
              <FaTrophy style={{ fontSize: '2rem', color: '#f5a623' }} />
              <div>
                <span className="prize-label">Your Prize</span>
                <span className="prize-amount"><FaDollarSign className="icon-inline" />100</span>
              </div>
            </div>
      ...
      <section className="how-to-play">
        <h2 className="section-title"><FaClipboardList className="icon-inline" /> How to Play</h2>
        <div className="steps">
          <div className="step">
      ...
      <section id="terms" className="terms-section">
        <h2 className="section-title"><FaScroll className="icon-inline" /> Terms & Conditions</h2>
