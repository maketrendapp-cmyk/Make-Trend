...
// Hero section + form – modern, spacious, and responsive
// ============================================================
...
export function AuthProvider({ children }) {
  // ... (all existing AuthProvider logic stays exactly the same)
  // I've omitted it here for brevity, but you must keep your existing AuthProvider code.
  // The only change is in the UI component below.
  // For this answer, I'm providing the full UI component rewrite.
}
...
// ============================================================
// AUTH SCREEN UI – SPLIT‑SCREEN FULL PAGE
// ============================================================
      ...
      <div className="min-h-screen flex flex-col lg:flex-row bg-white">
        ...
        <div className="flex-1 flex items-center justify-center p-6 lg:p-12 bg-white">
          <div className="w-full max-w-md">
            ...
            {/* ── Mobile hero title (only on small screens) ── */}
