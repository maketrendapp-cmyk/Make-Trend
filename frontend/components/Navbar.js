          ...
          <div className="flex h-12 sm:h-14 items-center justify-between">
            ...
            <Link href="/" className="flex items-center gap-1.5 group flex-shrink-0">
              <img 
                src="/favicon.ico" 
                alt="Make Trend" 
                className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg shadow-md group-hover:shadow-lg transition-all group-hover:scale-105"
              />
              ...
              {isAuthenticated ? (
                <>
                  <Link
                    href="/profile"
                    className="
                      flex items-center gap-1.5 px-2.5 sm:px-3.5 py-1.5 sm:py-2
                ...
                <Link
                  href="/login"
                  className="
                    flex items-center gap-1.5 px-3.5 sm:px-5 py-1.5 sm:py-2 
            ...
            <button
              ...
              className="md:hidden p-1.5 sm:p-2 rounded-lg text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-all duration-200 flex-shrink-0"
